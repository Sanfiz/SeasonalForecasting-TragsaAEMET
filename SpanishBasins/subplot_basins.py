...
#########################
#paths
shapefile_path = '/sclim/cly/cly/SRS/cuencas'
masivo_path =  '/MASIVO/cly'
results_path = '/sclim/cly/cly/SRS/cuencas/results'
...
grib_path = 'Seasonal_Verification/1-Sf_variables/data/ecmwf_s51_stmonth09_hindcast1993-2016_monthly.grib'
hcst_fname = os.path.join(masivo_path, grib_path)
...
for i, basin in basins.iterrows():
    ...
    output_csv = os.path.join(results_path, f'grid_points_within_{basin.name+1}.csv')
    ...
    output_image = os.path.join(results_path, f'basin_{i + 1}_with_table.png')
